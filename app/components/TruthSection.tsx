                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-6 ps-lg-5">
                        <div className="glass-card p-4 p-md-5">
                            ...
                            <p className="fs-5 text-dim mb-4 readability-shadow">
                            ...
                            <p className="fs-5 text-dim mb-5 readability-shadow">
                            ...
                            <Link
                                href={affiliateLink}
                                className="btn-cosmic text-decoration-none d-inline-block w-100 text-center"
                            >
